...
@section('content')
    <div class="cruises-container lmd-container">
        ...
        <div class="content">
            <div class="content-header row">
                <div class="results-number column "><h1>We offer <span class="number">{{$excursions->total()}}</span> cruise and stay</h1></div>
                <div class="line"></div>
                <div class="last-minute-box-xl column hide-l">
                    <p>Browse through the advanced search filter for our complete cruise deal offers. Set sail with Croatia Cruise all year round and enjoy the wonders of Adriatic Coast. Click to find out more.
                    </p>
                </div>
                <div class="active-filters column hide-xl">
                    <a href="{{route('cruises.cruiseAndStay')}}" class="button primary filter-trigger lmd-trigger hide-l">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => UI.cruiseAndStayInit()); // (2)
    </script>
@endsection
